...
//       if (!token) return;
//       try {
//         const response = await axios.get(`${process.env.NEXT_PUBLIC_HOST}/admin/user/all/arttist/list`, {
//           headers: { Authorization: `Bearer ${token}` },
//         });
...
//       | { target: { title: string; value: string } }
//   ) => {
//     const { title, value } = e.target;

//     if (errors[title as keyof FormErrors]) {
...
//     const requiredFields: (keyof Product)[] = ["title", "artist", "category", "medium", "price", "stock", "status"];
...
//         sku: formData.sku,
//         sizeInInches: formData.dimensions, 
//         sizeInCMS: "",
//         stock: Number(formData.stock),
//         status: formData.status,
//         image: formData.image,
//         createdById: formData.artist,
//       };
...
//           <input
//             type="text"
//             placeholder="Search by title, artist, category, medium, year, SKU..."
//             value={searchQuery}
//             onChange={(e) => {
...
//                 <td className="p-4">{product.createdBy.name}</td>
